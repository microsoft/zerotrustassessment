...
- [Review the iOS app protection settings reference](https://learn.microsoft.com/intune/app-management/protection/ref-settings-ios?wt.mc_id=zerotrustrecommendations_automation_content_cnl_csasci)
