...
- [Configure Platform SSO for macOS in Intune](https://learn.microsoft.com/intune/device-configuration/settings-catalog/configure-platform-sso-macos?wt.mc_id=zerotrustrecommendations_automation_content_cnl_csasci) – *Step-by-step guidance for enabling Platform SSO on macOS devices.*
- [Single sign-on (SSO) overview and options for Apple devices in Microsoft Intune](https://learn.microsoft.com/intune/device-configuration/enterprise-sso-plugin?pivots=macos&wt.mc_id=zerotrustrecommendations_automation_content_cnl_csasci) – *Overview of SSO options available for Apple platforms.*
<!--- Results --->
%TestResult%
