...
- [Create terms and conditions policy](https://learn.microsoft.com/intune/device-enrollment/create-terms-and-conditions?wt.mc_id=zerotrustrecommendations_automation_content_cnl_csasci)
<!--- Results --->
%TestResult%
