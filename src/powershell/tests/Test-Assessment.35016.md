...
- Monitor adoption using [Monitor label usage](https://learn.microsoft.com/en-us/purview/sensitivity-labels-usage)
- Verify that `disablemandatoryinoutlook` is NOT enabled (should be false) unless intentionally exempting Outlook
- Consider integrating with DLP policies using [Create DLP policies based on labels](https://learn.microsoft.com/en-us/purview/dlp-use-labels-as-conditions)
