...
For detailed guidance: [Restrict access to content by using encryption in sensitivity labels](https://learn.microsoft.com/en-us/microsoft-365/compliance/encryption-sensitivity-labels)

**Who**: Compliance Administrator, Security Administrator, or Information Protection Administrator

**When**: During initial sensitivity label deployment and as part of data protection framework configuration

**Where**: Microsoft Purview portal → Information Protection → Labels → Sensitivity labels
<!--- Results --->
%TestResult%
