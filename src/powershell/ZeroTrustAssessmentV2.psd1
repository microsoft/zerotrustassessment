#
# Module manifest for module 'ZeroTrustAssessmentV2'
#
...
RootModule = 'ZeroTrustAssessmentv2.psm1'
...
GUID = '9c86e6db-c362-44cc-813a-103dac81554e'
...
FormatsToProcess = 'ZeroTrustAssessmentV2.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
# NestedModules = @()

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Connect-ZtAssessment', 'Get-ZtGraphScope', 'Get-ZtTest',
               'Invoke-ZtAssessment', 'Invoke-ZtGraphRequest', 'Disconnect-ZtAssessment'
