Why: Admins should be signing in with phishing resistant authentication to protect their identities. This will help block remote attacks against privileged identities.
