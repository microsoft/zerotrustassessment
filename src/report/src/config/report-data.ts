...
export const reportData: ZeroTrustAssessmentReport = {
  "ExecutedAt": "2025-07-23T20:41:46.35571+10:00",
  ...
  "TenantInfo": {
    ...
    "OverviewCaMfaAllUsers": {
      "description": "Over the past 30 days, 39.9% of sign-ins were protected by conditional access policies enforcing multifactor.",
      "nodes": [
        {
          "source": "User sign in",
