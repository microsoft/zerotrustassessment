...
export const reportData: ZeroTrustAssessmentReport = {
  "ExecutedAt": "2025-03-03T21:42:59.834653+11:00",
  ...
  "Tests": [
    ...
    },
    {
      ...
      "TestImpact": "Medium",
      "TestId": "22124",
      "TestResult": "\nFound 5 unaddressed high priority Entra recommendations.\n\n\n## Unaddressed high priority Entra recommendations\n\n| Display Name | Status | Insights |\n| :--- | :--- | :--- |\n| Protect all users with a user risk policy  | active | You have 43 of 43 users that don’t have a user risk policy enabled.  |\n| Protect all users with a sign-in risk policy | active | You have 43 of 43 users that don't have a sign-in risk policy turned on. |\n| Ensure all users can complete multifactor authentication | active | You have 29 of 43 users that aren’t registered with MFA.  |\n| Require multifactor authentication for administrative roles | active | You have 3 of 8 users with administrative roles that aren’t registered and protected with MFA. |\n| Renew expiring application credentials | active | Your tenant has applications with credentials that will expire soon. |\n\n",
  ...
  "TenantInfo": {
    "OverviewCaDevicesAllUsers": {
      "description": "Over the past 28 days, 0% of sign-ins were from compliant devices.",
      "nodes": [
        {
          "target": "Unmanaged",
          "value": 2275,
    ...
    "OverviewCaMfaAllUsers": {
      "description": "Over the past 28 days, 99% of sign-ins were protected by conditional access policies enforcing multifactor.",
      "nodes": [
        {
