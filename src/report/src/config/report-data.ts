...
export const reportData: ZeroTrustAssessmentReport = {
  "ExecutedAt": "2025-08-07T20:07:49.923764+10:00",
  ...
  "Tests": [
    ...
    },
    {
      ...
      "TestResult": "\nFound 5 unaddressed high priority Entra recommendations.\n\n\n## Unaddressed high priority Entra recommendations\n\n| Display Name | Status | Insights |\n| :--- | :--- | :--- |\n| Protect all users with a user risk policy  | active | You have 3 of 62 users that don’t have a user risk policy enabled.  |\n| Protect all users with a sign-in risk policy | active | You have 62 of 62 users that don't have a sign-in risk policy turned on. |\n| Ensure all users can complete multifactor authentication | active | You have 47 of 62 users that aren’t registered with MFA.  |\n| Enable policy to block legacy authentication | active | You have 3 of 62 users that don’t have legacy authentication blocked.  |\n| Require multifactor authentication for administrative roles | active | You have 5 of 11 users with administrative roles that aren’t registered and protected with MFA. |\n\n\n",
      "TestRisk": "High",
      "TestSkipped": "",
    ...
    },
    {
      ...
      "TestResult": "\nNo inactive applications with privileged Entra built-in roles\n\n\n## Apps with privileged Entra built-in roles\n\n| | Name | Role | Assignment | App owner tenant | Last sign in|\n| :--- | :--- | :--- | :--- | :--- | :--- |\n| ✅ | [Salesforce](https://entra.microsoft.com/#view/Microsoft_AAD_IAM/ManagedAppMenuBlade/~/Overview/objectId/d22f071d-e8d3-41fc-a516-b29753cdd1f6/appId/b650c3c1-3395-40bb-8471-2a6a8b76d8a9) | Application Administrator | Permanent |  | 2025-07-23 | \n\n\n",
      "TestRisk": "High",
      "TestSkipped": "",
