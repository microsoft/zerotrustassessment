...
export function Footer() {
    return (
        <footer className="flex flex-col items-center justify-between gap-4 min-h-[3rem] md:h-20 py-2 md:flex-row">
            <p className="text-center text-sm leading-loose text-muted-foreground md:text-left">Generated using <a href="https://www.powershellgallery.com/packages/ZeroTrustAssessmentV2" target="_blank" rel="noreferrer" className="font-medium underline underline-offset-4">ZeroTrustAssessment v2</a>. Share feedback and report issues → <a href="https://aka.ms/ztworkshop/v2/feedback" target="_blank" rel="noreferrer" className="font-medium underline underline-offset-4">Feedback</a>.</p>
