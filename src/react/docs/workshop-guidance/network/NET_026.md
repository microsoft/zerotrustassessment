...
To enable the Base secure web gateway (SWG) capabilities, organizations should start by onboarding the Microsoft 365 traffic using Microsoft Entra Internet Access for Microsoft services.
